/*************************************************************************
   ...
   Version:    V1.3
   Date:       13.02.96
   Function:   Index heapsort an REAL array
...
/************************************************************************/
/*>void indexreal(int n, REAL *arrin, int *indx)
   ---------------------------------------------
   Input:  n      int      Number of elements in array
           arrin  *REAL    Array to be indexed
   Output: indx   *int     Index array
   
   Index a REAL array by Heapsort.
   
   03.06.90 Original
   01.06.92 ANSIed and autodoc'd
   13.02.96 Rewritten
*/
void indexreal(int n, int *arrin, int *indx)
{
   int  i, j, l, ir, 
        indxt;
   REAL q;
